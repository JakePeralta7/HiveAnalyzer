...
class Hive:
    ...
    def get_value_data(self, reg_key, reg_value_name):
        ...
        last_modified = reg_key_obj.header.last_modified / 10 ** 7
    ...
    def convert_hex_filetime(self, timestamp_hex_bytes):
        ...
        shutdown_time_decimal = int.from_bytes(timestamp_hex_bytes, byteorder='little', signed=False) / 10**7
    ...
    def convert_decimal_filetime(timestamp_decimal):
        ...
        timestamp = datetime(1601, 1, 1) + timedelta(seconds=timestamp_decimal)
